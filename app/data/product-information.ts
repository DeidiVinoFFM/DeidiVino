...
const wineryAddresses: Record<string, string> = {
  ...
  "Weingut Christian Bamberger": "Weingut Christian Bamberger – Steinhardter Hof, Kreuznacher Straße 2, 55566 Bad Sobernheim, Deutschland",
...
const researched: Record<string, Partial<ProductInformation>> = {
  ...
  W0111: {
    alcohol: "12,5 % vol.",
    ingredients: "Trauben, Saccharose, Antioxidationsmittel: Sulfite",
    allergens: "Enthält Sulfite",
    nutrition: {
    ...
    producer: "Weingut Bischel GbR, Sonnenhof 15, 55437 Appenheim, Deutschland",
    sourceLabel: "Fotografiertes Rücketikett und zugehöriges E-Label des Grauer Burgunder 2024",
    verification: "verified",
  },
  W0112: { alcohol: "12,0 % vol.", allergens: "Enthält Sulfite", producer: "Weingut Bischel GbR, Sonnenhof 15, 55437 Appenheim, Deutschland", sourceLabel: "Fotografiertes Rücketikett des Rosé trocken 2023", verification: "verified" },
  W0114: { alcohol: "13,0 % vol.", allergens: "Enthält Sulfite", producer: "Weingut Bischel GbR, Sonnenhof 15, 55437 Appenheim, Deutschland", sourceLabel: "Fotografiertes Rücketikett des Appenheim Weißburgunder & Chardonnay trocken 2023", verification: "verified" },
  W0115: { alcohol: "13,0 % vol.", allergens: "Enthält Sulfite", producer: "Weingut Bischel GbR, Sonnenhof 15, 55437 Appenheim, Deutschland", sourceLabel: "Fotografiertes Rücketikett des Chardonnay Réserve trocken 2022", verification: "verified" },
  W0116: { alcohol: "12,0 % vol.", allergens: "Enthält Sulfite", producer: "Vertrieb: Weingut Bischel GbR, Sonnenhof 15, 55437 Appenheim, Deutschland", sourceLabel: "Fotografiertes Rücketikett des Riesling Brut 2022", verification: "verified" },
  W0117: { alcohol: "13,0 % vol.", allergens: "Enthält Sulfite", producer: "Weingut Bischel GbR, Sonnenhof 15, 55437 Appenheim, Deutschland", sourceLabel: "Fotografiertes Rücketikett des Appenheimer Hundertgulden Riesling GG 2023", verification: "verified" },
  W0118: { alcohol: "13,0 % vol.", allergens: "Enthält Sulfite", producer: "Weingut Bischel GbR, Sonnenhof 15, 55437 Appenheim, Deutschland", sourceLabel: "Fotografiertes Rücketikett des Binger Scharlachberg Riesling GG 2023", verification: "verified" },
  W0119: { alcohol: "13,0 % vol.", allergens: "Enthält Sulfite", producer: "Weingut Bischel GbR, Sonnenhof 15, 55437 Appenheim, Deutschland", sourceLabel: "Fotografiertes Rücketikett des Siefersheimer Heerkretz Riesling GG 2023", verification: "verified" },
  W0120: { alcohol: "13,0 % vol.", allergens: "Enthält Sulfite", producer: "Weingut Bischel GbR, Sonnenhof 15, 55437 Appenheim, Deutschland", sourceLabel: "Fotografiertes Rücketikett des Gau-Algesheimer St. Laurenzikapelle Riesling GG 2023", verification: "verified" },
  W0121: { alcohol: "13,5 % vol.", allergens: "Enthält Sulfite", producer: "Weingut Bischel GbR, Sonnenhof 15, 55437 Appenheim, Deutschland", sourceLabel: "Fotografiertes Rücketikett des Appenheim Spätburgunder trocken 2019", verification: "verified" },
  W0122: { alcohol: "13,5 % vol.", allergens: "Enthält Sulfite", producer: "Weingut Bischel GbR, Sonnenhof 15, 55437 Appenheim, Deutschland", sourceLabel: "Fotografiertes Rücketikett des Gau-Algesheim Johannisberg Spätburgunder trocken 2020", verification: "verified" },
  W0123: { alcohol: "13,0 % vol.", allergens: "Enthält Sulfite", producer: "Weingut Bischel GbR, Sonnenhof 15, 55437 Appenheim, Deutschland", sourceLabel: "Fotografiertes Rücketikett des Pinot Noir Réserve trocken 2021", verification: "verified" },
  ...
  W0071: { alcohol: "12,5 % vol.", allergens: "Enthält Sulfite", producer: "Weingut Christian Bamberger – Steinhardter Hof, Kreuznacher Straße 2, 55566 Bad Sobernheim, Deutschland", sourceLabel: "Fotografiertes Rücketikett des Grauburgunder trocken 2022", verification: "verified" },
  W0072: { alcohol: "13,0 % vol.", allergens: "Enthält Sulfite", producer: "Weingut Christian Bamberger – Steinhardter Hof, Kreuznacher Straße 2, 55566 Bad Sobernheim, Deutschland", sourceLabel: "Fotografiertes Rücketikett des Weißburgunder trocken 2021", verification: "verified" },
  W0080: { alcohol: "12,0 % vol.", allergens: "Enthält Sulfite", producer: "Weingut Christian Bamberger – Steinhardter Hof, Kreuznacher Straße 2, 55566 Bad Sobernheim, Deutschland", sourceLabel: "Fotografiertes Rücketikett des Glückslos trocken 2023", verification: "verified" },
  W0081: { alcohol: "11,0 % vol.", allergens: "Enthält Sulfite", producer: "Weingut Christian Bamberger – Steinhardter Hof, Kreuznacher Straße 2, 55566 Bad Sobernheim, Deutschland", sourceLabel: "Fotografiertes Rücketikett des Augenblick trocken 2023", verification: "verified" },
  W0082: { alcohol: "13,0 % vol.", allergens: "Enthält Sulfite", producer: "Weingut Christian Bamberger – Steinhardter Hof, Kreuznacher Straße 2, 55566 Bad Sobernheim, Deutschland", sourceLabel: "Fotografiertes Rücketikett des Riesling Vulkangestein 2021", verification: "verified" },
  W0084: { alcohol: "13,5 % vol.", allergens: "Enthält Sulfite", producer: "Weingut Christian Bamberger – Steinhardter Hof, Kreuznacher Straße 2, 55566 Bad Sobernheim, Deutschland", sourceLabel: "Fotografiertes Rücketikett des Spätburgunder Vulkangestein 2020", verification: "verified" },
  W0085: { alcohol: "13,5 % vol.", allergens: "Enthält Sulfite", producer: "Weingut Christian Bamberger – Steinhardter Hof, Kreuznacher Straße 2, 55566 Bad Sobernheim, Deutschland", sourceLabel: "Fotografiertes Rücketikett des Spätburgunder Vulkangestein 2021", verification: "verified" },
