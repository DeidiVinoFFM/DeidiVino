...
export default function DatenschutzPage() {
  return (
    <main className="legal-page">
      ...
      <h2>6. Cookies, Analyse und weitere externe Inhalte</h2>
      <p>
        Diese Website setzt keine eigenen Cookies, keine Analyse- oder Werbewerkzeuge und
        keine extern geladenen Schriftarten ein. Es sind keine Karten, Videos oder
        Social-Media-Feeds eingebettet.
      </p>
